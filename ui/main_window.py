...
class MainWindow(QMainWindow):
    ...
    def reset_all_views(self):
        """Resetta TUTTI gli output delle view quando si cambia wallet"""
    ...
    def get_available_skins(self):
        """Restituisce lista di skin disponibili"""
    ...
    def update_balance_label(self, balance, crypto):
        """Aggiorna il saldo nella sidebar (chiamato solo dopo richiesta utente)"""
        if not self.backend:
            return
        try:
